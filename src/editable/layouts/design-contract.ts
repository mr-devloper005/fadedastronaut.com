...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#073032',
  '--slot4-panel-bg': '#f3f6f5',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#536768',
  '--slot4-soft-muted-text': '#999999',
  '--slot4-accent': '#08b88a',
  '--slot4-accent-fill': '#08b88a',
  '--slot4-accent-soft': '#e4faf3',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#073032',
  ...
  '--editable-page-text': '#073032',
  '--editable-container': '1280px',
  '--editable-border': '#dbe4e2',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#073032',
  '--editable-nav-active': '#08b88a',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#08b88a',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#073032',
